...
public class Constant {
  ...
  //Admin panel url
  public static final String MainBaseUrl = "https://pracheta.co/admin/"; //Admin panel url with it whould be nessesary to put "/"(slash) at end of the url (https://admin.panel.url/)
  ...
  public static final String WebSiteUrl = "https://pracheta.co/admin/";
    ...
    //**********APIS**********
    public static final String RECHARGE1 = BaseUrl + "recharge.php";
    ...
    public static final String USERPINCODE = "user_pincode";
