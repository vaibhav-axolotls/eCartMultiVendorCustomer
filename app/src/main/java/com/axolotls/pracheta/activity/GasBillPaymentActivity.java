...
public class GasBillPaymentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbarTitle.setText("Gas Biil Payment");
        edtphone_number.setHint("Gas Account Number");
        try {
...
//            JSONObject employee = obj.getJSONObject("Status");
        ...
        builder = new AlertDialog.Builder(GasBillPaymentActivity.this);
        image = new ImageView(GasBillPaymentActivity.this);
        ...
        Integer[] integers=new Integer[]{R.drawable.ic_vadodaragas, R.drawable.ic_uniquegas,R.drawable.ic_tripuragas, R.drawable.ic_sitigas};
        String[] strings=new String[]{"Vadodara Gas","Unique Central Piped Gases","Tripura Natural Gas","Siti Energy"};
