...
public class WaterBillPaymentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbarTitle.setText("Water Biil Payment");
        edtphone_number.setHint("Water Consumer Number");
        try {
...
//            JSONObject employee = obj.getJSONObject("Status");
        ...
        builder = new AlertDialog.Builder(WaterBillPaymentActivity.this);
        image = new ImageView(WaterBillPaymentActivity.this);
        ...
        Integer[] integers=new Integer[]{R.drawable.ic_punewater, R.drawable.ic_pcmcwater,R.drawable.ic_delhiwater};
        String[] strings=new String[]{"Pune Municipal Corporation","Pimpri Chinchwad Municipal Corporation (PCMC)","New Delhi Municipal Council (NDMC)"};
