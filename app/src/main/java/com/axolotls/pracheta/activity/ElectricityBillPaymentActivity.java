...
//    String JSON_STRING = "{\"Status\":\"xyz\"}";
    ...
    static double walletbalance,minamount = 200;
    TextView textView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtphone_number.setHint("Electricity CA Number");
...
//        }
        ...
        builder = new AlertDialog.Builder(ElectricityBillPaymentActivity.this);
        image = new ImageView(ElectricityBillPaymentActivity.this);
        ...
        Integer[] integers=new Integer[]{R.drawable.ic_mahavitran};
        String[] strings=new String[]{"MSEDCL - MAHARASHTRA"};
        ...
        payButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (phone_number.length() != 10) {
                    ...
                    edtAmount.setError("recharge Amount should be greater than 200 Rs.");
