...
public class LandlineBillPayment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbarTitle.setText("Landline Biil Payment");
        edtphone_number.setHint("Landline Number");
        try {
...
//            JSONObject employee = obj.getJSONObject("Status");
        ...
        builder = new AlertDialog.Builder(LandlineBillPayment.this);
        image = new ImageView(LandlineBillPayment.this);
        ...
        Integer[] integers=new Integer[]{R.drawable.ic_mtnl, R.drawable.ic_mtnl,R.drawable.ic_bsnl};
        String[] strings=new String[]{"MTNL - Mumbai","MTNL - Delhi","BSNL landline - Individiual"};
